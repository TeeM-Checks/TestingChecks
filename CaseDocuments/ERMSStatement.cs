...
{
    public class ERMSStatement
    {

        Common cm = new Common();

        public string CreatePackage(string filePath, ermsStatementResponseObject ermsObj, string agentAccount, string customerNames, string ermsStatus, string ermsBalance)
        {
            string retValue = "";
            ...
            try
            {
                ...
                Font fontSizeNormal9 = new Font(Font.FontFamily.HELVETICA, 9, Font.NORMAL);
                ...
                float imageWidthF = 155f;
                float imageHeightF = 100f;
                ...
                Paragraph paraTicketNoText = new Paragraph("Customer Code :", fontSizeNormalBoldColour);
                ...
                Paragraph paraTicketNoValue = new Paragraph(agentAccount, fontSizeNormal);
                ...
                Paragraph paraCreatedDateText = new Paragraph(" Name(s):", fontSizeNormalBoldColour);
                ...
                Paragraph paraCreatedDateValue = new Paragraph(customerNames, fontSizeNormal);
                ...
                Paragraph paraReferenceText = new Paragraph("Account Status :", fontSizeNormalBoldColour);
                ...
                Paragraph paraReferenceValue = new Paragraph(ermsStatus, fontSizeNormal);
                ...
                Paragraph paraDueDateText = new Paragraph(" Balance :", fontSizeNormalBoldColour);
                ...
                Paragraph paraDueDateValue = new Paragraph(ermsBalance, fontSizeNormal);
            ...
            //private string _closing_balance;
                ...
                PdfPTable Page2Table1 = new PdfPTable(15);
                Page2Table1.WidthPercentage = 100;
                Page2Table1.HorizontalAlignment = Element.ALIGN_CENTER;

                PdfPCell Page2Cell1ONE = new PdfPCell();
                Page2Cell1ONE.VerticalAlignment = Element.ALIGN_LEFT;
                Paragraph paraOff1 = new Paragraph("Trans ID", fontSizeNormalBold);
                paraOff1.Alignment = Element.ALIGN_CENTER;
                Page2Cell1ONE.AddElement(paraOff1);

                PdfPCell Page2Cell1TWO = new PdfPCell();
                Page2Cell1TWO.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1TWO.AddElement(new Paragraph("Trans Date", fontSizeNormalBold));

                PdfPCell Page2Cell1THREE = new PdfPCell();
                Page2Cell1THREE.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1THREE.AddElement(new Paragraph("Trans Type", fontSizeNormalBold));

                PdfPCell Page2Cell1FOUR = new PdfPCell();
                Page2Cell1FOUR.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1FOUR.AddElement(new Paragraph("Track No", fontSizeNormalBold));

                PdfPCell Page2Cell1FIVE = new PdfPCell();
                Page2Cell1FIVE.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1FIVE.AddElement(new Paragraph("Ent No", fontSizeNormalBold));

                PdfPCell Page2Cell1SIX = new PdfPCell();
                Page2Cell1SIX.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1SIX.AddElement(new Paragraph("Form Code", fontSizeNormalBold));

                PdfPCell Page2Cell1SEVEN = new PdfPCell();
                Page2Cell1SEVEN.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1SEVEN.AddElement(new Paragraph("Trans Ref", fontSizeNormalBold));

                PdfPCell Page2Cell1EIGHT = new PdfPCell();
                Page2Cell1EIGHT.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1EIGHT.AddElement(new Paragraph("Serv Code", fontSizeNormalBold));

                PdfPCell Page2Cell1NINE = new PdfPCell();
                Page2Cell1NINE.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1NINE.AddElement(new Paragraph("Trans Description", fontSizeNormalBold));

                PdfPCell Page2Cell1TEN = new PdfPCell();
                Page2Cell1TEN.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1TEN.AddElement(new Paragraph("Original Amount", fontSizeNormalBold));

                PdfPCell Page2Cell1ELEVEN = new PdfPCell();
                Page2Cell1ELEVEN.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1ELEVEN.AddElement(new Paragraph("Open Amount", fontSizeNormalBold));

                PdfPCell Page2Cell1TWELVE = new PdfPCell();
                Page2Cell1TWELVE.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1TWELVE.AddElement(new Paragraph("On Hold", fontSizeNormalBold));

                PdfPCell Page2Cell1THIRTEEN = new PdfPCell();
                Page2Cell1THIRTEEN.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1THIRTEEN.AddElement(new Paragraph("Trans Status ID", fontSizeNormalBold));

                PdfPCell Page2Cell1FOURTEEN = new PdfPCell();
                Page2Cell1FOURTEEN.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1FOURTEEN.AddElement(new Paragraph("Effective Date", fontSizeNormalBold));

                PdfPCell Page2Cell1FIFTEEN = new PdfPCell();
                Page2Cell1FIFTEEN.VerticalAlignment = Element.ALIGN_LEFT;
                Page2Cell1FIFTEEN.AddElement(new Paragraph("Closing Bal", fontSizeNormalBold));

                Page2Table1.AddCell(Page2Cell1ONE);
                Page2Table1.AddCell(Page2Cell1TWO);
                Page2Table1.AddCell(Page2Cell1THREE);
                Page2Table1.AddCell(Page2Cell1FOUR);
                Page2Table1.AddCell(Page2Cell1FIVE);
                Page2Table1.AddCell(Page2Cell1SIX);
                Page2Table1.AddCell(Page2Cell1SEVEN);
                Page2Table1.AddCell(Page2Cell1EIGHT);
                Page2Table1.AddCell(Page2Cell1NINE);
                Page2Table1.AddCell(Page2Cell1TEN);
                Page2Table1.AddCell(Page2Cell1ELEVEN);
                Page2Table1.AddCell(Page2Cell1TWELVE);
                Page2Table1.AddCell(Page2Cell1THIRTEEN);
                Page2Table1.AddCell(Page2Cell1FOURTEEN);
                Page2Table1.AddCell(Page2Cell1FIFTEEN);

                float[] Page2columnWidthONE = new float[] { 5f, 5f, 5f, 10f, 10f, 5f, 5f, 5f, 10f, 10f, 5f, 5f, 5f, 5f, 5f };
                Page2Table1.SetWidths(Page2columnWidthONE);
                doc.Add(Page2Table1);
                #endregion

                #region Transaction Value row
                PdfPTable P2tableeighthA = new PdfPTable(15);
                P2tableeighthA.DefaultCell.Border = Rectangle.RECTANGLE;
                P2tableeighthA.WidthPercentage = 100;
                P2tableeighthA.HorizontalAlignment = Element.ALIGN_CENTER;

                #region Transaction Value row

                for (int k = 0; k < ermsObj.responseDataSet.Length; k++)
                {
                    ermsStatementObject ermsObject = null;
                    ermsObject = ermsObj.responseDataSet[k];

                    if (ermsObject != null)
                    {
                        PdfPCell P2eigthfirstA = new PdfPCell();
                        P2eigthfirstA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigthsecondA = new PdfPCell();
                        P2eigthsecondA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigththirdA = new PdfPCell();
                        P2eigththirdA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigthfourthA = new PdfPCell();
                        P2eigthfourthA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigthfifthA = new PdfPCell();
                        P2eigthfirstA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigthsixthA = new PdfPCell();
                        P2eigthsixthA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigthseventhA = new PdfPCell();
                        P2eigthseventhA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigtheighthA = new PdfPCell();
                        P2eigtheighthA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigthninethA = new PdfPCell();
                        P2eigthninethA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigthtenthA = new PdfPCell();
                        P2eigthtenthA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigtheleventhA = new PdfPCell();
                        P2eigtheleventhA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigthtwelvethA = new PdfPCell();
                        P2eigthtwelvethA.VerticalAlignment = Element.ALIGN_CENTER;


                        PdfPCell P2eigththirteenA = new PdfPCell();
                        P2eigththirteenA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigthfourteenA = new PdfPCell();
                        P2eigthfourteenA.VerticalAlignment = Element.ALIGN_CENTER;

                        PdfPCell P2eigthfifteenA = new PdfPCell();
                        P2eigthfifteenA.VerticalAlignment = Element.ALIGN_CENTER;

                        P2eigthfirstA.AddElement(new Phrase(ermsObject.trans_id, fontSizeNormal9));
                        P2eigthsecondA.AddElement(new Phrase(ermsObject.trans_date, fontSizeNormal9));
                        P2eigththirdA.AddElement(new Phrase(ermsObject.trans_type_id, fontSizeNormal9));

                        P2eigthfourthA.AddElement(new Phrase(ermsObject.trak_no, fontSizeNormal9));
                        P2eigthfifthA.AddElement(new Phrase(ermsObject.ent_no, fontSizeNormal9));
                        P2eigthsixthA.AddElement(new Phrase(ermsObject.form_code, fontSizeNormal9));

                        P2eigthseventhA.AddElement(new Phrase(ermsObject.trans_reference, fontSizeNormal9));
                        P2eigtheighthA.AddElement(new Phrase(ermsObject.service_rend_code, fontSizeNormal9));
                        P2eigthninethA.AddElement(new Phrase(ermsObject.trans_desc, fontSizeNormal9));

                        P2eigthtenthA.AddElement(new Phrase(ermsObject.original_amount, fontSizeNormal9));
                        P2eigtheleventhA.AddElement(new Phrase(ermsObject.open_amount, fontSizeNormal9));
                        P2eigthtwelvethA.AddElement(new Phrase(ermsObject.on_hold, fontSizeNormal9));

                        P2eigththirteenA.AddElement(new Phrase(ermsObject.trans_status_id, fontSizeNormal9));
                        P2eigthfourteenA.AddElement(new Phrase(ermsObject.effective_date, fontSizeNormal9));
                        P2eigthfifteenA.AddElement(new Phrase(ermsObject.closing_balance, fontSizeNormal9));
                        ...
                        P2tableeighthA.AddCell(P2eigthfirstA);
                        P2tableeighthA.AddCell(P2eigthsecondA);
                        P2tableeighthA.AddCell(P2eigththirdA);

                        P2tableeighthA.AddCell(P2eigthfourthA);
                        P2tableeighthA.AddCell(P2eigthfifthA);
                        P2tableeighthA.AddCell(P2eigthsixthA);

                        P2tableeighthA.AddCell(P2eigthseventhA);
                        P2tableeighthA.AddCell(P2eigtheighthA);
                        P2tableeighthA.AddCell(P2eigthninethA);

                        P2tableeighthA.AddCell(P2eigthtenthA);
                        P2tableeighthA.AddCell(P2eigtheleventhA);
                        P2tableeighthA.AddCell(P2eigthtwelvethA);

                        P2tableeighthA.AddCell(P2eigththirteenA);
                        P2tableeighthA.AddCell(P2eigthfourteenA);
                        P2tableeighthA.AddCell(P2eigthfifteenA);

                        float[] P2eighthwidthsA = new float[] { 5f, 5f, 5f, 10f, 10f, 5f, 5f, 5f, 10f, 10f, 5f, 5f, 5f, 5f, 5f };
                        P2tableeighthA.SetWidths(P2eighthwidthsA);
                    }
                }
                #endregion

                doc.Add(P2tableeighthA);
                #endregion
